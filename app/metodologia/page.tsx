...
export default function MetodologiaPage() {
  ...
  const T = isEn ? {
    ...
    polDesc: 'AI-GPR methodology (Iacoviello & Tong, 2026). Claude Sonnet 4.6 classifies each article by category (political/economic/both/irrelevant) and severity (0–1). PRR_t = 100 × Σs_it / S̄. Mean = 100, unbounded. Crisis periods: 200–400+.',
    ...
    polDesc: 'Metodología AI-GPR (Iacoviello & Tong, 2026). Claude Sonnet 4.6 clasifica cada artículo por categoría (político/económico/ambos/irrelevante) y severidad (0–1). PRR_t = 100 × Σs_it / S̄. Media = 100, sin límite superior. Períodos de crisis: 200–400+.',
