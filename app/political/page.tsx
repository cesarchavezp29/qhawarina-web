      ...
      <main className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight mb-2">
            Índice de Inestabilidad Política — {parseLocalDate(data.current.date).toLocaleDateString('es-PE', { day: 'numeric', month: 'short', year: 'numeric' })}
          </h1>
        ...
        <div className="grid grid-cols-5 gap-4 mb-8">
          ...
          <div className="border border-gray-300 p-4">
            ...
            <div className="text-xs text-gray-600 mt-1">
              {parseLocalDate(data.aggregates['year_max_date']).toLocaleDateString('es-PE', { day: 'numeric', month: 'short' })}
            </div>
          </div>
          <div className="border border-gray-300 p-4">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">
                        {parseLocalDate(event.date).toLocaleDateString('es-PE', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric'
                        })}
