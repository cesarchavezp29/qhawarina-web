...
const DATA_SECTIONS: DataSection[] = [
  {
    ...
    files: [
      ...
      {
        name: "Índice de Riesgo Político (IRP) — Serie Diaria",
        description: "IRP diario y suavizado 7 días para Perú. Incluye ambos índices IRP e IRE (dual index AI-GPR). Media = 100.",
      ...
      {
        name: "Índice de Riesgo Económico (IRE) — Serie Diaria",
        description: "IRE diario y suavizado 7 días. Extraído de political_index_daily.json (economic_7d / economic_raw). Media = 100.",
        file: "political_index_daily.json",
        format: "JSON",
        csvFile: "riesgo_economico.csv",
        rows: "438 días",
      },
      {
        name: "Picos Mensuales IRP / IRE",
        description: "Tabla de picos mensuales del IRP e IRE desde ene-2025. Incluye fecha del pico, valor 7d, evento principal y 3 artículos top por dimensión.",
        file: "risk_index_monthly_peaks.json",
        format: "JSON",
        csvFile: "indices_riesgo_mensual.csv",
        rows: "15 meses",
      },
      {
