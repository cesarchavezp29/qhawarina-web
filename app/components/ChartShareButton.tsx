...
export default function ChartShareButton({ shareText, url }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        title={isEn ? 'Share chart' : 'Compartir gráfico'}
        aria-label={isEn ? 'Share chart' : 'Compartir gráfico'}
      >
      ...
      {open && (
        <div
          className="absolute right-0 top-8 z-50 w-44 rounded-lg border border-gray-200 bg-white shadow-lg py-1"
        ...
        >
          ...
          <button
            ...
            style={{ color: copied ? '#15803d' : '#374151' }}
