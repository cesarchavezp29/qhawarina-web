...
export default function SobreNosotrosPage() {
  ...
  const T = isEn ? {
    ...
    models: ['Dynamic Factor Models (DFM) - statsmodels, scikit-learn', 'Machine Learning - Gradient Boosting, Ridge Regression', 'NLP - Claude Haiku (Anthropic)', 'Satellite - NOAA-VIIRS nighttime lights', 'Web Scraping - Beautiful Soup, VTEX REST API, RSS parsing'],
    ...
    models: ['Dynamic Factor Models (DFM) - statsmodels, scikit-learn', 'Machine Learning - Gradient Boosting, Ridge Regression', 'NLP - Claude Haiku (Anthropic)', 'Satelital - NOAA-VIIRS nighttime lights', 'Web Scraping - Beautiful Soup, VTEX REST API, RSS parsing'],
