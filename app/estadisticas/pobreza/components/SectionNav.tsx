...
const BASE = '/estadisticas/pobreza';
const TERRA = '#C65D3E';
...
const LINKS = [
  ...
  { href: `${BASE}/distritos`,     label: 'Distritos',   exact: false },
  { href: `${BASE}/trimestral`,    label: 'Trimestral',  exact: false },
  { href: `${BASE}/metodologia`,   label: 'Metodología', exact: false },
];

export default function PobrezaSectionNav() {
