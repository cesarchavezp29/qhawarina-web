...
const BASE = '/estadisticas/inflacion';
const TERRA = '#C65D3E';

const LINKS = [
  { href: BASE,                                    label: 'Resumen',      exact: true  },
  { href: `${BASE}/graficos`,                      label: 'Evolución',    exact: false },
  { href: `${BASE}/categorias`,                    label: 'Categorías',   exact: false },
  { href: `${BASE}/mapas`,                         label: 'Regional',     exact: false },
  { href: `${BASE}/precios-alta-frecuencia`,       label: 'Alta Frec.',   exact: false },
  { href: `${BASE}/metodologia`,                   label: 'Metodología',  exact: false },
];

export default function InflacionSectionNav() {
